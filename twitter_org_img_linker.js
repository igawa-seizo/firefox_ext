...
function createLinkText (src, cnt) {
    ...
    var $span = $("<span></span>").css("margin-right", "1em")
    ...
    var $showA = $("<a></a>");
    $showA.addClass("show_org_image").attr("data-index", cnt).attr("data-href", target).attr("download", filename).css({
            "margin-right" : "0.5em",
            "text-decoration" : "none",
            "color" : "hsl (0, 0%, 0%)"
        }).append(circleNumberList[cnt] + $showIcon);
